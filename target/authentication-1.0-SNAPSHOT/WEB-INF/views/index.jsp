...
<body style="height: 648px;" class="login-body">
	...
	<div id="doc">
		...
		<div id="hd" class="clearfix" style="padding-top: 96px;">
			<div class="logo">
				<a href="http://i.360.cn/?sb_param=61d99123f52188d5879a595fd3e37ab8"
					hidefocus="true"></a>
			</div>
		</div>
		<!--内容部分-->
		...
		<div class="info" style="margin-top: 132px;" style="display:none;">
			...
			<span><a target="_blank" href="javascript:void(0);">360首页</a></span>
			<span class="split">|</span> <span><a class="registerNew"
				id="register" href="javascript:void(0);">注册新帐号</a></span>
			<span class="split">|</span>
			<span id="otherLogin" style="font-size:16px;">弹框登录</span>
		</div>
							...
							<div class="quc-mod-sign-in quc-mod-normal-sign-in">
									...
									<form class="quc-form">
										...
										<!-- <p class="quc-field quc-field-third-part">
											<span>其他帐号登录：</span><span class="quc-third-part"><a
												href="http://i.360.cn/login?src=pcw_i360&destUrl=http%3A%2F%2Fi.360.cn#"
												class="quc-third-part-icon quc-third-part-icon-sina"
												title="新浪微博登录"></a><a
												href="http://i.360.cn/login?src=pcw_i360&destUrl=http%3A%2F%2Fi.360.cn#"
												class="quc-third-part-icon quc-third-part-icon-renren"
												title="人人登录"></a><a
												href="http://i.360.cn/login?src=pcw_i360&destUrl=http%3A%2F%2Fi.360.cn#"
												class="quc-third-part-icon quc-third-part-icon-fetion"
												title="飞信登录"></a><a
												href="http://i.360.cn/login?src=pcw_i360&destUrl=http%3A%2F%2Fi.360.cn#"
												class="quc-third-part-icon quc-third-part-icon-telecom"
												title="天翼登录"></a></span>
										</p> -->
									</form>
								</div>
								<div class="quc-footer" style="display: none;">
									<a class="quc-link quc-link-grey quc-link-normal-sign-in"
										href="http://i.360.cn/login?src=pcw_i360&destUrl=http%3A%2F%2Fi.360.cn#">使用其他帐号登录</a><a
										class="quc-link quc-link-grey quc-link-quick-sign-in"
										href="http://i.360.cn/login?src=pcw_i360&destUrl=http%3A%2F%2Fi.360.cn#"
										style="display: none;">返回快速登录</a><a
										class="quc-link quc-link-grey quc-link-sign-up"
										href="http://i.360.cn/login?src=pcw_i360&destUrl=http%3A%2F%2Fi.360.cn#">注册新帐号</a><a
										class="quc-link quc-link-about quc-link-about-normal"
										href="http://i.360.cn/findpwd/" target="_blank">忘记密码？</a><a
										class="quc-link quc-link-about quc-link-about-mobile"
										href="http://i.360.cn/help/smscode" target="_blank">校验码常见问题</a><a
										class="quc-link quc-link-about quc-link-about-qrcode"
										href="http://i.360.cn/login?src=pcw_i360&destUrl=http%3A%2F%2Fi.360.cn#">什么是二维码登录？</a><a
										class="quc-link quc-link-about quc-link-about-onekey"
										href="http://i.360.cn/login?src=pcw_i360&destUrl=http%3A%2F%2Fi.360.cn#">什么是一键登录？</a>
								</div>
							</div>
						</div>
					</div>
   ...
   <div class="quc-panel quc-wrapper" id="loginDialog"
		...
		<!--
<br>	353afb941b4df8ed	==	page_load
<br>	353afb941b4df8ed	==	page_load:0.012
