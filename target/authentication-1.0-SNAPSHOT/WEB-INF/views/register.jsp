...
<body style="height: 867px;">
	...
	<div id="doc">
		...
		<div id="hd" class="clearfix" style="padding-top: 96px;">
			<div class="logo">
				<a href="http://i.360.cn/?sb_param=bc53add68b9af7ff3202dd69a5435f69"
					hidefocus="true"></a>
			</div>
		</div>
		<!--内容部分-->
		...
		<div class="info" style="margin-top: 132px;">
			...
			<span class="split">|</span> <span><a href="/authentication"
				class="reg2login">已有360帐号</a></span>
		</div>
									...
									<p class="quc-field-licence">
										<label><input class="quc-checkbox" type="checkbox"
											...
											style="font-size: 12px;">我已经阅读并同意<a
												...
												href="http://i.360.cn/pub/protocol.html" target="_blank">《360用户服务条款》</a></span></label>
									</p>
