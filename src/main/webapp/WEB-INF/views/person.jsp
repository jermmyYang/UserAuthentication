...
<link rel="stylesheet" href="${ctx }/resources/js/bootstrap-datepicker/css/datepicker.css">

</head>

<input type="hidden" id="h_s" value="${user.sex }">
<div id="h_b" style="display:none;">
<fmt:formatDate value="${user.birthday}" type="date" dateStyle="short"/>
</div>
...
<body style="height: 636px;">
		...
		<div class="uc-nav">
			<div class="nav">
				<ul class="mainnav">
					...
					<li><a href="javascript:void(0);" id="safeBtn">帐号安全</a></li>
					<li><a href="javascript:void(0);" id="accountBtn">帐号信息</a></li>
						...
						<div class="u-main">
							...
							<div class="txt">
							    ...
							    <c:if test="${empty user.userName }">
							        <h2>${user.phone}</h2>
							        <p>
									  <a href="javascript:void(0);" class="lnk" id="setName">设置用户名</a>
								    </p>
							    </c:if>
								 ...
								 <c:if test="${not empty user.userName }">
							        ...
							        <p>
									  <a href="javascript:void(0);" class="lnk" id="setName" >修改用户名</a>
								    </p>
							      </c:if>
								<p>
									<a href="javascript:void(0);" class="lnk" id="modifyInfo">修改个人资料</a>
								</p>
							</div>
						</div>
						<div class="u-detail">
	...
	<div class="quc-panel quc-wrapper" id="modifyDialog"
		style="top: 200px; left: 45%; position: absolute; display: none;">
...
<div class="quc-panel quc-wrapper" id="emailDialpg"
	...
	<script src="${ctx}/resources/js/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
    <script src="${ctx}/resources/js/bootstrap-datepicker/js/locales\bootstrap-datepicker.zh-CN.js"></script>
    ...
    <script src="${ctx}/resources/js/basic/sy.template.js"></script>
    <script src="${ctx}/resources/js/basic/sy.error_message.js"></script>
